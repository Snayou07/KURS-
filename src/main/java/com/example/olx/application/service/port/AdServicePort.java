...
public interface AdServicePort {
    Ad createAd(AdCreationRequest request);
    ...
    void deleteAd(String adId, String currentUserId); // Поточний користувач для перевірки прав
    Ad updateAd(String adId, AdCreationRequest request, String currentUserId); // Оновлення оголошення
}